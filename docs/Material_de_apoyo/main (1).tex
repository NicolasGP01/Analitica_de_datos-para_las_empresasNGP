...
\usepackage[letterpaper,left = 1.0in , right = 1.0in , top = 0.8in , bottom = 1.0in]{geometry}
% Useful packages
\usepackage{graphicx}
\usepackage{url}
\usepackage{array}
...
\usepackage[T1]{fontenc} % Que acente los acentos que tenemos en el español.

% Opciones del paquete Hyperref - Option PDF --------
\usepackage{hyperref} % Insertar Ipervinculos
\hypersetup{
    colorlinks=true,
    linkcolor=black,
    filecolor=red,    
